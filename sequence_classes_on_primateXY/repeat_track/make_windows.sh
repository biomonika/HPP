#!/bin/bash
#SBATCH --job-name=make_windows.20230616
...
#SBATCH --output=make_windows.20230616.%j.log
...
references=("chrY.human.WideHardmasked.fasta" "chrY.chimpanzee.WideHardmasked.fasta" "chrY.bonobo.WideHardmasked.fasta" "chrY.gorilla.WideHardmasked.fasta" "chrY.sorang.WideHardmasked.fasta" "chrY.borang.WideHardmasked.fasta" "chrY.gibbon.WideHardmasked.fasta")

threads=1

#CREATE THE 50kb windows
...
do
	...
	#generate windows of the size 50k using a version of the Y chromosome
