#script by Monika Cechova mcechova@ucsc.edu with the help of Emily Xu
#inspired by script hetDetection.R written by G. Logsdon from https://github.com/mrvollger/NucFreq
